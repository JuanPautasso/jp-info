...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 20px;">
  <div style="flex: 1; min-width: 250px;">
    ...
    <p style="margin: 10px 0; line-height: 1.6;">
      As a PhD Candidate in Medical Imaging at Radboudumc, I am dedicated to advancing diagnostic and treatment technologies for breast cancer through innovative imaging solutions. My work combines machine learning, and system optimization to improve imaging accuracy and outcomes.
    </p>
  </div>
