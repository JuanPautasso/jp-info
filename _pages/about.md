...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 20px;">
  <div style="flex: 1; padding-right: 10px;">
    <h2 style="margin: 0; display: flex; align-items: center;">🔬 Driving Innovation in Image Optimization</h2>
  ...
  <div style="flex-shrink: 0; margin-top: -5px;"> <!-- Adjusted the image position -->
